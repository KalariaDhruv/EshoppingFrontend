	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<div align="right" class="collapse navbar-collapse"
				...
				<img
					src="${pageContext.servletContext.contextPath}/resources/logo1.jpg"
				...
				<div class="collapse navbar-collapse" id="navDemo">
					<ul class="nav navbar-nav">
						...
						<li class="dorpdown"> <a class="dropdoen-toggle" data-toggle="dropdown" href="#">Admin List<span class="caret"></span></a>
						...
						<li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#">Category Choice<span class="caret"></span></a>
							...
							<li class="active"><c:forEach items="${catList}"
									var="cat">
									<a href="${pageContext.request.contextPath }/productCustList?cid=${cat.cid}">${cat.cname }<font
